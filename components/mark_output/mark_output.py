...
class mark_output(OpenRTM_aist.DataFlowComponentBase):
    ...
    def onExecute(self, ec_id):
        ...
        if self._photospot_inIn.isNew(): #テキストデータが来たか確認
            ...
            # 画像を読み込む
            #image1 = "C:/Users/reore/Documents/RToutput"
            image = Image.open(f"{self._image1[0]}/{name}.jpg")  # 画像のパスを指定
            ...
            image_path = f'{self._image_path1[0]}/coordinates_plot_{name}.jpg'  # 保存するパス
